        ...
        <div data-speed="0" data-type="html" class="rd-parallax-layer">
            <div class="shell section-top-57 section-bottom-30 section-md-top-125 section-lg-top-200">
                <div class="veil reveal-md-block">
                    <h1 class="text-bold">Rent Bike</h1>
                </div>
                <ul
                    ...
                    <li><a href="#" class="text-white">Bike</a></li>
                    <li>rent-bike </li>
                </ul>
            </div>
        </div>
...
@section('content')
    <main class="page-content">
        ...
        <section class="section-90 section-md-111 text-left">
            <div class="shell">
                <h2 class="text-bold text-center text-lg-left">Bikes</h2>
                            ...
                            <div class="reveal-block">
                                ...
                                <div class="post post-boxed">
                                    ...
                                    <header class="post-media"><img  style="max-width:570px; max-height:310px"
                                            src="/images/blog/post-05-570x280.jpg" alt=""
                                            class="img-responsive" /></header>
                                    <!-- Post content-->
                                    <section class="post-content text-left">
                                        <div class="post-tags group-sm"><a href="#"><span
                                                    class="label-custom label-lg-custom label-primary">{{ $row->Code->value }}</span></a>
                                        </div>
                                         <div class="post-body">
                                            <!-- Post Title-->
                                            <div class="post-title">
                                                <div class="h4 text-bold text-white"><a > {{ $row->Model->value }} </a>
                                                </div>
                                            </div>
                                            <div class="post-meta">
                                                <ul class="list-inline list-inline-sm p">
                                                    <li><span class="text-middle icon-xxs mdi mdi-calendar"></span>
                                                        <time datetime="2016-01-01"
                                                            class="text-middle inset-left-6 text-ripe-lemon"> {{$row->Status->value}} </time>
                                                    </li>

                                                    <li class="text-middle">Bike price &nbsp;<span
                                                            class="inset-left-3 text-ripe-lemon"> {{$row->PriceHour->value}} $</span>
                                                    </li>
